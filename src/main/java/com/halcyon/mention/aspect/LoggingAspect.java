package com.halcyon.mention.aspect;
...
public class LoggingAspect {
    ...
    @Before("execution(* com.halcyon.mention.service.*.*.*(..))")
    ...
    @AfterReturning(pointcut = "execution(* com.halcyon.mention.service.*.*.*(..))", returning = "result")
    ...
    @AfterThrowing(pointcut = "execution(* com.halcyon.mention.service.*.*.*(..))", throwing = "ex")
